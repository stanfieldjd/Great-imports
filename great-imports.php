 ...
 * Description: Full evidence-first Eventbrite importer with manual cleanup, review candidates, source-page display reports, coverage audits, import previews, and review reports.
 * Version: 0.2.7
...
define( 'GREAT_IMPORTS_VERSION', '0.2.7' );
